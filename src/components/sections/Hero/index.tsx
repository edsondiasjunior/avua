    ...
    <>
      <section className="px-8 lg:px-16 py-22 flex flex-col items-center justify-end relative w-full h-[70vh]">
        <div className="grid grid-cols-12 gap-10 w-full">
          ...
          <div
            data-hero-side
            className="col-span-12 lg:col-span-4 self-start sm:self-end sm:justify-self-end flex flex-col gap-4 items-start justify-center max-w-[450px] sm:border-l sm:pl-22"
          >
