...
export default function Hero() {
  return (
    <>
      <section className="px-8 lg:px-16 py-22 flex flex-col items-center justify-end relative h-[70vh]">
        <div className="grid grid-cols-12 gap-10 w-full">


          <RevealTitle
            as="h1"
            className="col-span-12 lg:col-span-8 text-start  max-w-[990px] self-end"
          >
          ...
          <div
            data-hero-side
            className="col-span-12 lg:col-span-4 self-start sm:self-end sm:justify-self-end flex flex-col gap-4 items-start justify-center max-w-[450px] border-l pl-22"
          >
