...
const tiers = [
  {
    ...
    features: [
      "Criação de site profissional com modelo de layout",
  ...
  },
  {
    ...
    id: "tier-enterprise",
    href: "#",
    priceMonthly: "Solicite um Orçamento",
    description:
      "Site feito de forma artesanal, com layout do zero e gestor de projeto exclusivo.",
    features: [
    ...
    <div className="relative isolate bg-black px-6 py-24 sm:py-32 lg:px-8">
      ...
      >
        <div
          ...
          className="mx-auto aspect-1155/678 w-288.75 bg-linear-to-tr opacity-20"
        />
      </div>
